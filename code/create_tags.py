...
#for tag_id in xrange(start, end+1,tagsppage):
    ...
    output.write(create_tags(traffic_sign_type1,traffic_sign_type2,traffic_sign_type3,tag_id-offset,tag_id+1-offset,tag_id+2-offset,False))
    output.write(distance_row)
    output.write(create_tags(tag_id,tag_id+1,tag_id+2,tag_id-offset,tag_id+1-offset,tag_id+2-offset,False))
    output.write(end_page)

    #This writes the IDs on the next page
    output.write(new_page)
    output.write(create_tags("empty","empty","empty",tag_id-offset,tag_id+1-offset,tag_id+2-offset,False))
    output.write(distance_row)
    output.write(create_tags("empty","empty","empty",tag_id-offset,tag_id+1-offset,tag_id+2-offset,True))
    output.write(end_page)
